...
const land_contract_fee = [
  ...
  { name: "value", type: "number", required: false },
  { name: "gen_entries", type: "boolean", key: "switch", required: false },
  { name: "note", type: "text", required: false },
];
...
const accounting_voucher_pattern_group = {
  ...
  forms: {
    general: accounting_voucher_pattern_general,
    fields: accounting_voucher_pattern_fields,
    sms: accounting_voucher_pattern_sms,
  },
};
...
const contract_financial = [
  ...
  { label: "start_date", name: "start_date", type: "date", required: false },
  { label: "end_date", name: "end_date", type: "date", required: false },
  { label: "paid_type", name: "paid_type", type: "number", required: false },
  {
    label: "cost_center_id",
    name: "cost_center_id",
    type: "uuid",
...
const voucher_pattern_group = {
  steps: ["general", "fields", "sms"],
  forms: {
    general: voucher_pattern_general,
    fields: voucher_pattern_fields,
    sms: voucher_pattern_sms,
  },
};
// ==== End Voucher
...
console.log(FORMS['bill_pattern']);

export default function getFormByTableName(name) {
  console.log("🚀 ~ file: new-tables-forms.js:7008 ~ getFormByTableName ~ name:", name, name === 'bill_pattern')
  if(name === 'bill_pattern') return FORMS['bill_pattern']
  return FORMS[name];
}
