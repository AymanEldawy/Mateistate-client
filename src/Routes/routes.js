...
const authProtectedRoutes = [
  ...
  { path: "/account/:number", component: <Account /> },
  { path: "/user", component: <User /> },
  { path: "/user/:number", component: <User /> },
  { path: "/building", component: <Building /> },
  { path: "/apartment", component: <Apartment /> },
  { path: "/parking", component: <Parking /> },
  { path: "/bank", component: <Bank /> },
  { path: "/building/:number", component: <Building /> },
  { path: "/apartment/:number", component: <Apartment /> },
  { path: "/parking/:number", component: <Parking /> },
  { path: "/bank/:number", component: <Bank /> },
  { path: "/bill", component: <Bill /> },
  { path: "/bill/:code", component: <Bill /> },
  { path: "/bill/:code/:number", component: <Bill /> },
  { path: "/cost_center", component: <CostCenter /> },
  { path: "/cost_center/:number", component: <CostCenter /> },
  ...
  { path: "/owner/:number", component: <Owner /> },
  { path: "/lessor/:number", component: <Lessor /> },
  { path: "/seller/:number", component: <Seller /> },
  { path: "/reservation-property/:number", component: <Home /> },
  { path: "/currency/:number", component: <Currency /> },
  { path: "/shop/:number", component: <Shop /> },
  { path: "/land/:number", component: <Land /> },
  { path: "/villa/:number", component: <Villa /> },
  ...
  { path: "/owner_expenses_types/:number", component: <OwnerExpensesEypes /> },
  { path: "/owner_expenses/:number", component: <OwnerExpenses /> },
  { path: "/watchman/:number", component: <Home /> },
  { path: "/lawsuit/:number", component: <Lawsuit /> },
  { path: "/store/:number", component: <Store /> },
  { path: "/material_group/:number", component: <MaterialGroup /> },
  { path: "/material", component: <Material /> },
  { path: "/material_group/:number", component: <MaterialGroup /> },
  { path: "/material/:number", component: <Material /> },
  { path: "/service/:number", component: <Service /> },
  ...
  { path: "/user_work_times/:number", component: <UserWorkTimes /> },
  ...
  { path: "/evacuation_request/:number", component: <EvacuationRequest /> },
  ...
  { path: "/cheque", component: <Cheque /> },
  { path: "/cheque/:code", component: <Cheque /> },
  { path: "/cheque/:code/:number", component: <Cheque /> },
  { path: "/contract", component: <Contract /> },
  { path: "/contract/:type/:name/:number", component: <Contract /> },
