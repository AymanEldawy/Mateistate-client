...
import { ContractRevenueFilters } from "../../Components/ReportsComponents/ContractRevenuesReport/ContractRevenueFilters";
...
const ContractRevenuesReport = () => {
  ...
  return (
    <BlockPaper title={"Contract Revenues Report"}>
      <FormProvider {...methods}>
        <form onSubmit={handleSubmit(onSubmit)} noValidate className="relative">
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 lg:gap-8 items-start">
            <ContractRevenueFilters />
...
export default ContractRevenuesReport;
